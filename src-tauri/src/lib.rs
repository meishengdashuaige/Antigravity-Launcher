...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_current_account,
            commands::launch_account_instance,
            ...
            // Antigravity proxy launcher commands
            commands::launch_antigravity,
            commands::restart_antigravity,
            commands::close_antigravity,
            commands::get_antigravity_process_status,
            commands::create_proxy_desktop_shortcut,
            commands::generate_proxy_launch_script,
